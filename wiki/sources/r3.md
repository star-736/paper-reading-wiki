...
- **需实验或作者披露**：60 MB/轨迹 的 routing tensor 成本写在 [Miles](miles-v0-1.md)，**不是**本页数字。本页只报 <3% rollout 延迟。1M 上下文下带宽是否仍可忽略，两边都没有曲线。
- **需实验或作者披露**：主实验是数学 RLVR + 一个 SWE 设定，全是 Qwen3-30B-A3B。更粗专家、更多层、异步 staleness 更大时，只重放 mask 够不够？
- **需实验或作者披露**：TIS+R3 略低于 R3：是「缝已收、再夹有害」，还是超参没重搜？没有对照表。
