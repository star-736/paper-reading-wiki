...
Serving 上，Qwen3.5-Omni 这类「Thinker / Talker / codec decoder」全模态模型天然需要 [Any-to-any 多模态 serving](../concepts/any-to-any-multimodal-serving.md)：模型页解释结构，vLLM-Omni 则把结构拆成 stage graph 独立 serve（Thinker、Talker、Vocoder / DiT 分 stage 调度、批处理和传输）。
