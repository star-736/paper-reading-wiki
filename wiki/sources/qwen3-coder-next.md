...
>
> 顺带澄清：**Qwen3-Next 本身没有独立技术报告**（只有 2025-09 [官方博客](qwen3-next-blog.md) + HF 权重），本篇 Qwen3-Coder-Next（arXiv:2603.00729）是 Qwen3-Next 家族里第一篇正式 report。Qwen3-Next 的架构事实以 HF config 为 tier-1、官方博客为设计动机的外部佐证，别去找一篇不存在的「Qwen3-Next 技术报告」。
