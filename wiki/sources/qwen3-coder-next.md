...
- **架构**：继承 Qwen3-Next 的 hybrid attention MoE，80B 总参 / 3B 激活（~3.75% 激活率）。
...
- 报告说「based on Qwen3-Next」，但具体层数、GDN:attention 比例、是否完全照搬 Qwen3-Next 配置，需读架构节核对（本页未把比例写成确定值，避免从 Qwen3-Next 外推）。
