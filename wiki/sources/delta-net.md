...
- Schlag 等 2021（arXiv:2102.11174）的小规模数字与「ELU+1 + L1」原配方，不能用本页 340M 消融反推。
- 块对角 Householder、把 head 做大同时塞进 SRAM，§5.3 只作为可行方向，没有实验。
- 3B / 1T 相对 PowerLM 的差距有多少来自缺门、多少来自状态尺寸，本页没有拆。
