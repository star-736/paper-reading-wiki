...
> **生产端 caveat**：报告里的 MTP-1 仅是 V4 preview 发布时的 baseline；preview 上线两周后，生产 serving 引擎里 MTP-1 已被 [DSpark](../sources/dspark.md) 整体替换（semi-AR drafter + confidence-scheduled verification）。V4-Flash per-user 生成速度 +60–85%、V4-Pro +57–78%。当前 deepseek.com 服务的速度主张本质来自 DSpark，不是 V4 报告本身。
