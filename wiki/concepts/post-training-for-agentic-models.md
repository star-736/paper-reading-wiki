...
description: "面向 agent 的 RL、MOPD、蒸馏、LLM RL policy optimization、ARPO 这类 step-level rollout 采样、GiGPO/HGPO 这类 history-aware step 组 advantage，以及 SAO 这类异步单 rollout。"
